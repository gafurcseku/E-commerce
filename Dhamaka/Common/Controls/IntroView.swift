...
class IntroView: UIView{
    ...
    private func insertViewElements(_ elements: [UIView], _ rotation: rotationWay){
        ...
        for i in 0...elements.count-1 {
            ...
            case .horizontal:
                ...
                viewArray[i]?.frame = CGRect(x: pageToFloatHorizontal(i), y: 0, width: getWidth(), height: CGFloat(200.0))
    ...
    private func builder(_ count: Int, _ rotation: rotationWay){
        ...
        scrollView.frame = CGRect(x: 0, y: 0, width: Int(UIScreen.main.bounds.width), height: Int(200))
